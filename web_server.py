    ...
    try:
        ...
        if template:
            ...
            user_config = {
                ...
                'trade_mode': frontend_config.get('trade_mode') or data.get('trade_mode') or config.GRID_DEFAULT_TRADE_MODE,
                'fixed_volume': int(frontend_config.get('fixed_volume') or data.get('fixed_volume') or 0),
        ...
        return jsonify({
            ...
            'config': {
                ...
                'trade_mode': session.trade_mode,
                'fixed_volume': session.fixed_volume,

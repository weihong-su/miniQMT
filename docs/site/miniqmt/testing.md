...
最近一次（2026-09-18）使用 Anaconda `python39` 执行 `--all-with-fast` 实测：**37 组、152 模块、3240 用例、3240 通过、0 失败、0 错误、0 跳过，成功率 100%**。

## 测试统计速查

| 版本 | 日期 | 非fast组 | 含fast | 通过率 |
|------|------|----------|--------|--------|
| Unreleased | 2026-09-18 | 37 组, 152 模块, 3240 用例 | 3240 | 100% |
